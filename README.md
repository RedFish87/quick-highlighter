...
Quick Highlighter listens to keyboard events, reads and modifies the text of pages you visit in order to display highlights, and requires clipboard access to copy your highlights. It runs entirely on your local machine and stores nothing.
